...
int dp_needle(int dimension)
{
	...
	int input_seq_1_size = dimension;
	int input_seq_2_size = dimension;
	...
	if (print_results)
		fprintf(stderr, "Computing dynamic programming results\n");
	t1 = gettime();
	...
	if (print_results)
		fprintf(stderr, "Trace solution back\n");
